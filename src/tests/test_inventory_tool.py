"""TEST 1A: Inventory Tool Test

Tests get_inventory_risk() tool independently.
...
try:
    ...
    if count == 0:
        ...
        print("\n" + "="*60)
        print("TEST 1A: PASS" if all(f in result for f in expected_fields) else "TEST 1A: FAIL")
        print("="*60)
    
except Exception as e:
    print(f"\n✗ TEST 1A FAILED: {str(e)}")
    import traceback
    traceback.print_exc()
    print("="*60)